...
public:
  ...
  /// Spinel: Create a new extension point after ASan. 
  void registerAfterOptimizerLastEPCallback(
      const std::function<void(ModulePassManager &, OptimizationLevel)> &C) {
    AfterOptimizerLastEPCallbacks.push_back(C);
  }
